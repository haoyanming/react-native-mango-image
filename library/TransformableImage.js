  ...
  render() {
    ...
    return (
      <ViewTransformer
        ...
        singleTapUp={this.props.singleTapUp}
        style={this.props.style}>

        {this.state.loading ? (this.props.loadingView && this.props.loadingView()) : null}
        ...
        <Image
          ...
          onProgress={(e) => this.props.progress && this.props.progress(Math.round(e.nativeEvent.loaded / e.nativeEvent.total))}
